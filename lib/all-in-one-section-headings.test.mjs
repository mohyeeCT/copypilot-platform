...
test('older versioned jobs keep their fallback and legacy jobs display their generated heading', () => {
  assert.deepEqual(selectPageCopySectionHeadings({
    isVersionedPageCopy: true,
    generatedHeading: '',
  ...
  assert.deepEqual(selectPageCopySectionHeadings({
    ...
    generatedHeading: 'Useful Party Hat Details',
    plannedHeading: 'Ignored legacy plan',
    safeFallbackHeading: 'collection_guidance',
    evidenceSparse: false,
  }), {
    displayHeading: 'Useful Party Hat Details',
    exportHeading: 'collection_guidance',
  })
})
