...
export default function NewBrandPulseProfileAlertPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      router.push(id ? `/brand-mentions/${id}` : `/brand-mentions/profiles/${profileId}`)
    } catch (submitError) {
                  ...
                  <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Coalition brand alert"
                        required
                      />
                    </div>
                    <div>
