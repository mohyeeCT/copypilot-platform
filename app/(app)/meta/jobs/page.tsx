...
export default function Page() {
  return (
    <JobsListPage tool={{
      label:       'Meta Copy',
      variant:     'meta',
      description:'Create, review, and export title tags, meta descriptions, and optimized H1s.',
      newHref:     '/meta/jobs/new',
      jobHref:     (id) => `/meta/jobs/${id}`,
      icon:        Tag,
      accent:      '#F59E0B',
      emptyTitle:  'No Meta Copy jobs yet',
      emptyDesc:   'Generate title tags, meta descriptions, and optimized H1s at scale with keyword scoring.',
      supportsClientProfiles: true,
      listJobs:    (token, clientProfileId) => metaApi.listJobs(token, clientProfileId),
